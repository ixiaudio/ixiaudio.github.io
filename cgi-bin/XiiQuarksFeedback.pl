...
BEGIN
{
  ...
  $postmaster        = 'info@ixi-audio.net';

  @referers          = qw(www.ixi-audio.net ixi-audio.net www.ixi-software.net ixi-software.net localhost);
  @allow_mail_to     = qw(thor@ixi-audio.net enrike@ixi-audio.net);
  @recipients        = ();
  %recipient_alias   = (
         'ixi' => 'enrike@ixi-audio.net, thor@ixi-audio.net',
		);
...
From: thor@ixi-audio.net
Subject: ixiQuarks feedback


Thank you very much.

We appreciate that you took time to give us this feedback on ixiQuarks.

It is instrumental in improving the usability and our understanding of 
the ixiQuarks and digital musical instruments in general. 
