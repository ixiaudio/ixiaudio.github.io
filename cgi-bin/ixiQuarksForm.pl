...
BEGIN
{
  ...
  @referers          = qw(www.ixi-audio.net ixi-audio.net localhost);
  @allow_mail_to     = qw(thor@ixi-audio.net);
  @recipients        = ();
  %recipient_alias   = (
         'ixi' => 'thor@ixi-audio.net',
		);
...
From: info@ixi-audio.net
Subject: ixiQuarks feedback

Thank you very much for trying out ixiQuarks. As you have allowed us to contact you for questions regarding the software (for which we are very greatful) we might be in contact with you in the near future.
